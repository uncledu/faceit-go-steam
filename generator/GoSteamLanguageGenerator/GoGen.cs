...
namespace GoSteamLanguageGenerator
{
	public class GoGen
	{
		...
		public void EmitClasses(Node root, StringBuilder sb)
		{
			...
			sb.AppendLine("    \"github.com/dotabook/faceit-go-steam/steamid\"");
			sb.AppendLine("    \"github.com/dotabook/faceit-go-steam/rwu\"");
			sb.AppendLine("   . \"github.com/dotabook/faceit-go-steam/protocol/protobuf\"");
			sb.AppendLine(")");
			sb.AppendLine();
